...
> SpringBoot 自动装配靠 @EnableAutoConfiguration 扫描 spring.factories / ImportSelector。核心是约定优于配置。
...
SpringBoot自动装配源码要点 的核心是"结构化拆解、明确边界、可观测兜底"：在正确性与扩展性之间取平衡，用工程化手段把不确定性降到最低，并随规模持续演进。
