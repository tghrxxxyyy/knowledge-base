...
| L2 | **场景题** | 知识运用与权衡（"设计一个短链系统"） | `场景题与项目深挖` `系统设计面试实战` `SQL与数据库面试实战` `分布式与微服务面试实战` `算法与数据结构面试` | 场景设计 / 架构 / 分库分表 |
...
| 场景 | 短链 / 排行榜 / 秒杀 / 限流 | ⭐⭐⭐ | 场景题与项目深挖 / 系统设计面试实战 | 场景设计/ |
| 数据库 | 索引 B+树 / 事务隔离 / 锁 / SQL优化 / 分库分表 | ⭐⭐⭐ | SQL与数据库面试实战 | mysql知识.md |
| 分布式 | CAP / 分布式锁 / 分布式事务 / 一致性哈希 / 幂等 | ⭐⭐⭐ | 分布式与微服务面试实战 | 分布式系统核心问题 |
| 算法 | 数组/链表/树/二分/DP/图/堆/回溯 | ⭐⭐⭐ | 算法与数据结构面试 | 力扣 / 基础知识 |
| 系统设计 | 四步法 / 容量估算 / 题型套路 | ⭐⭐⭐ | 系统设计面试实战 | 架构/ |
...
| 文件 | 定位 |
|------|------|
| [Java与JVM八股精讲](Java与JVM八股精讲.md) | L1 八股：HashMap/JVM/GC/并发 |
| [MySQL与Redis八股精讲](MySQL与Redis八股精讲.md) | L1 八股：索引/事务/缓存三大问题 |
| [并发与分布式八股精讲](并发与分布式八股精讲.md) | L1 八股：锁/AQS/CAP/分布式 |
| [操作系统与网络八股精讲](操作系统与网络八股精讲.md) | L1 八股：进程/内存/TCP/HTTP |
| [消息队列八股精讲](消息队列八股精讲.md) | L1 八股：MQ 对比/丢失/幂等/积压 |
| [场景题与项目深挖](场景题与项目深挖.md) | L2/L3：系统设计场景 + 项目 STAR |
| [大厂真题与标准答](大厂真题与标准答.md) | L1/L2：高频真题与标准答法 |
| [系统设计面试实战](系统设计面试实战.md) | L2：四步法/容量估算/题型套路 ★ |
| [SQL与数据库面试实战](SQL与数据库面试实战.md) | L2：索引/事务/优化/分表 ★ |
| [分布式与微服务面试实战](分布式与微服务面试实战.md) | L2：CAP/锁/事务/一致性哈希/幂等 ★ |
| [算法与数据结构面试](算法与数据结构面试.md) | L2：数组/树/二分/DP/图/回溯 ★ |
| [项目经历与行为面试实战](项目经历与行为面试实战.md) | L3：STAR/深挖追问/行为题 ★ |
